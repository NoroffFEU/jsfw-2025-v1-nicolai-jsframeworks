...
function Layout() {
  return (
    <div>
      <Header />
      <div className="flex items-center justify-center md:h-[calc(100vh-80px)] h-screen bg-gray-500 md:m-10 m-0 md:rounded-3xl rounded-none overflow-x-hidden overflow-y-scroll">
        <Outlet />
