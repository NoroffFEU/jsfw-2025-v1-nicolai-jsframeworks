...
function ProductItem({ product }: ProductItemProps) {
  ...
  return (
    <div className="relative w-[282px] h-auto md:w-full aspect-square bg-accent/5 dark:bg-secondary/5 rounded-[10px] backdrop-blur p-1 flex flex-col items-center outline outline-1 outline-primary lg:hover:scale-[102%] transition-transform justify-self-center">
      ...
      <div className="p-3 md:p-4 !pb-8 absolute bottom-1 bg-secondary dark:bg-accent z-10 w-[calc(100%-8px)] h-fit rounded-[8px] flex items-start justify-between overflow-hidden">
        <h2 className="text-[14px] md:text-[16px] font-inter font-bold uppercase leading-4 md:leading-5 text-left tracking-[0.075rem] text-accent dark:text-secondary">
          {title}
        </h2>
        <div className="flex flex-col items-center justify-between my-auto w-fit gap-[6px] md:gap-[8px]">
          {discountedPrice ? (
      ...
      <div className="absolute bottom-0 left-3 md:left-2 z-20">
        <div className="relative">
          <div className="flex items-center gap-1 absolute transform left-1/2 -translate-x-1/2 translate-y-[45%] md:translate-y-[40%] z-30">
            ...
            {discountedPrice ? (
              <p className="text-secondary dark:text-accent font-micro text-[26px] md:text-[32px] leading-3">
      ...
      {/* Buttons */}
      <div className="absolute bottom-[-21px] lg:bottom-[-26px] left-3 md:left-2 -z-10">
        <div className="relative">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="127"
