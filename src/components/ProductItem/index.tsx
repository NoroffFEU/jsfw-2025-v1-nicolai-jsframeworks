...
function ProductItem() {
  return (
    <div className="relative w-[282px] h-auto sm:w-[328px] aspect-square bg-gray-100/[90%] rounded-[10px] backdrop-blur p-1 flex flex-col items-center outline outline-1 outline-primary hover:scale-[102%] transition-transform duration-500">
      {/* Image, ID */}
      ...
      <div className="p-3 sm:p-4 absolute bottom-1 bg-secondary z-10 w-[calc(100%-8px)] h-auto rounded-[8px] flex items-start justify-between overflow-hidden">
        <h2 className="text-[14px] sm:text-[16px] font-inter font-bold uppercase leading-4 sm:leading-5 text-left tracking-[0.075rem]">
          {product.title}
        </h2>
        <div className="flex flex-col items-center justify-between w-fit gap-[6px] sm:gap-[8px] pl-3">
        ...
        <p className="absolute bottom-[2px] right-0 text-[6px] sm:text-[8px] font-inter font-bold uppercase tracking-[0.1rem] p-[2px] bg-blend-difference bg-primary text-secondary">
          {product.tags[0]}
        </p>
      </div>

      {/* Price tag */}
      <div className="absolute bottom-0 left-3 sm:left-2 z-20">
        <div className="relative">
          <div className="flex items-center gap-1 absolute transform left-1/2 -translate-x-1/2 translate-y-[45%] sm:translate-y-[40%] z-30">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="12"
              height="11"
      ...
      {/* Buttons */}
      <div className="absolute bottom-[-21px] sm:bottom-[-26px] left-3 sm:left-2 -z-10">
        <div className="relative">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="127"
      ...
      <div className="absolute bottom-[-21px] sm:bottom-[-26px] right-3 sm:right-2 -z-20">
        <div className="relative">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="127"
