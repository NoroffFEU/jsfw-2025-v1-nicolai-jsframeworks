  ...
  return (
    <header className="text-white h-screen p-4 fixed top-0 left-0 right-0 pointer-events-none z-50">
      <nav>
        <Link
          to="/"
          className="uppercase font-iceland text-lg tracking-widest md:tracking-[0.75rem] w-fit text-primary md:text-accent md:dark:text-secondary md:-rotate-90 absolute md:left-9 md:top-1/2 transform md:-translate-x-1/2 z-10 md:-translate-y-1/2 top-12 left-1/2 -translate-x-1/2 pointer-events-auto transition-colors duration-500"
        >
          A.Warehouse
        </Link>
        <svg
