        ...
        <div className="flex flex-row flex-wrap gap-2 xl:gap-5 sm:col-start-2 md:col-start-1">
          ...
          <div className="flex flex-col justify-center gap-1 md:gap-2">
            ...
            <div className="flex flex-row items-center gap-2">
              <div className="w-8 h-8 relative group">
                ...
                >
                  ...
                  <path
                    ...
                    className="fill-primary dark:group-hover:fill-accent group-hover:fill-secondary !duration-300"
              ...
              <div className="w-7 h-7 relative bg-primary hover:bg-secondary dark:hover:bg-accent rounded-md rotate-45 ml-1 !duration-300">
                <button
